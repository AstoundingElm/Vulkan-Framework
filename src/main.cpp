...
int main(){
    ...
    image = material_image(&logical_device_context, &physical_device_context, &command_context, &load_texture_data, &q_context, ASSET_SPRITE_DEFAULT);
    
    //VK_CHECK(create_texture(&logical_device_context, &physical_device_context,
    //&command_context, &load_texture_data, &q_context));
    
    VK_CHECK(create_image_view(&logical_device_context, image));
