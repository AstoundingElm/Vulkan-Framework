...
PINLINE VkResult create_instance(instance_types * inst_context){
    ...
    VK_CHECK(vkCreateInstance(&instance_info, inst_context->allocator, &inst_context->instance));
    ...
    VK_CHECK(vkCreateDebugUtilsMessengerEXT(inst_context->instance, &debug_info, inst_context->allocator, &inst_context->debug_messenger ));
