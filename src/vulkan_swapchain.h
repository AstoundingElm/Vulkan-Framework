...
PINLINE VkResult create_swapchain(
    ...
    VK_CHECK(vkCreateSwapchainKHR(logical_context->logical_device, &swap_info, 0, &swapchain_context->swapchain));
...
PINLINE VkViewport create_viewport(float viewport_x, float viewport_y , float viewport_width, float viewport_height, float viewport_min_depth, float viewport_max_depth){
    ...
    viewport.maxDepth = viewport_max_depth;
