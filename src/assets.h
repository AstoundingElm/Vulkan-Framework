...
PINLINE const char * get_asset(asset_type_id asset_context){
    ...
    switch(asset_context){
        ...
        case ASSET_SPRITE_WHITE:{
            ...
            const char * default_texture  = "/home/petermiller/Desktop/4coder/hello/src/font_atlas.png";
        ...
        case ASSET_SPRITE_BALL:{break;}
        case ASSET_SPRITE_FONT_ATLAS:{break;}
        case ASSET_SPRITE_PADDLE:{break;}
    }
