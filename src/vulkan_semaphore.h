...
VkSemaphoreCreateInfo create_semaphore_info( const void * semaphore_pnext, VkSemaphoreCreateFlags semaphore_flags){
...
PINLINE VkResult create_semaphore_objects(logical_device_types * logical_context, semaphore_types * semaphore_context){
    ...
    VkFenceCreateInfo fence_info = create_fence_info(NULL, 0);
