...
PINLINE VkResult create_logical_device(instance_types * inst_context, logical_device_types * logical_context, physical_device_types * physical_context, queue_types * queue_context){
    ...
    VK_CHECK(vkCreateDevice(physical_context->physical_device_best_device, &device_info, inst_context->allocator, &logical_context->logical_device));
